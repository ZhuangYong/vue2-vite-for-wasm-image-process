...
<script>
import { BaseFabricComponent, timeLinePlayer } from "ps-wasm-vue2"
...
export default {
  ...
  created() {
    console.log('created this.timeLinePlayer', this.timeLinePlayer)
  },
  mounted() {
    console.log('this.timeLinePlayer', this.timeLinePlayer)
