...
<!--          </el-select>-->
<!--          &lt;!&ndash;<el-input v-model="targetProps.fontFamily" :disabled="disabled" size="mini" style="width: 60px" />&ndash;&gt;-->
<!--        </div>-->
...
<!--      <div class="props-line">-->
<!--        <div class="props-item">-->
<!--          &lt;!&ndash;<span class="label">W：</span>&ndash;&gt;-->
<!--          <el-input v-model="targetProps.width" :disabled="disabled">-->
<!--            <template #prefix>W &nbsp;&nbsp;</template>-->
<!--          </el-input>-->
<!--        </div>-->
<!--        <div class="props-item">-->
<!--          &lt;!&ndash;<span class="label">H：</span>&ndash;&gt;-->
...
<!--      <div class="props-line">-->
<!--        <div class="props-item">-->
<!--          &lt;!&ndash;<span class="label">X：</span>&ndash;&gt;-->
<!--          <el-input v-model="targetProps.left" :disabled="disabled">-->
<!--            <template #prefix>X &nbsp;&nbsp;</template>-->
<!--          </el-input>-->
<!--        </div>-->
<!--        <div class="props-item">-->
<!--          &lt;!&ndash;<span class="label">Y：</span>&ndash;&gt;-->
...
<!--      <div class="props-line">-->
<!--        <div class="props-item">-->
<!--          &lt;!&ndash;<span class="label">∠：</span>&ndash;&gt;-->
<!--          <el-input v-model="targetProps.angle" :disabled="disabled">-->
<!--            <template #prefix>∠ &nbsp;&nbsp;</template>-->
<!--          </el-input>-->
<!--        </div>-->
<!--        <div class="props-item">-->
<!--          &lt;!&ndash;<span class="label" style="width: 50px;">隐藏：</span>&ndash;&gt;-->
...
<!--      return this.target ? imageHelper.watchTarget(this.target) : imageHelper.defaultProps-->
<!--    }-->
<!--  },-->
<!--  watch: {-->
<!--    // target(v) {-->
